...
public class PizzaConfigTest {
    ...
    @BeforeEach
    public void setUp() {
        // Create a PizzaConfig with capacity for 3 OptionSets
        pizzaConfig = new PizzaConfig("Test Pizza", 3);
        pizzaConfig.setBasePrice(1000);
    }

    @Test
    public void testAddAndGetOptionSet() {
        OptionSet sizeSet = new OptionSet("Size", 3);
        boolean added = pizzaConfig.addOptionSet(sizeSet);
        assertTrue(added, "OptionSet should be added successfully");

        OptionSet retrieved = pizzaConfig.getOptionSet(0);
    ...
    public void testUpdateOptionSet() {
        ...
        OptionSet newSizeSet = new OptionSet("Updated Size", 3);
    ...
    public void testOptionSetCRUDOperations() {
        OptionSet toppingsSet = new OptionSet("Toppings", 5);
        pizzaConfig.addOptionSet(toppingsSet);

        // Testing Option CRUD within OptionSet:
        // 1. Create and add an Option
        OptionSet.Option pepperoni = toppingsSet.new Option("Pepperoni", 200);
        boolean optionAdded = toppingsSet.addOption(pepperoni);
        assertTrue(optionAdded, "Option 'Pepperoni' should be added successfully");
    ...
    public void testPrintMethodOutput() {
        // Create an OptionSet with one Option and add to PizzaConfig
        OptionSet sizeSet = new OptionSet("Size", 3);
        pizzaConfig.addOptionSet(sizeSet);
